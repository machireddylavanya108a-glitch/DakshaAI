  ...
  return (
    <header className="fixed top-0 left-0 md:left-64 right-0 h-16 bg-slate-950/80 backdrop-blur-md border-b border-slate-800 z-30 flex items-center justify-between px-4 md:px-8">
      <div className="flex items-center gap-2">
        <button onClick={onMenuClick} className="p-2 rounded-lg hover:bg-slate-900 md:hidden">
          <Menu className="w-5 h-5 text-slate-400" />
        </button>
        <div className="flex items-center gap-2 bg-slate-900 border border-slate-800 rounded-lg px-4 py-2 w-48 md:w-96">
