export default function LoadingQuiz() {
  return (
    <div className="rounded-3xl border border-indigo-500/20 bg-slate-900/80 p-8 text-center shadow-2xl shadow-indigo-950/30">
      ...
      <h3 className="text-xl font-semibold text-white">Generating your quiz</h3>
      <p className="mt-2 text-sm text-slate-400">Preparing a polished set of questions and explanations for you.</p>
    </div>
  );
}
