...
export default function HeroSpline() {
  ...
  return (
    <div className="relative isolate overflow-hidden rounded-[2.5rem] border border-white/10 bg-slate-950/70 shadow-[0_60px_120px_rgba(15,23,42,0.55)] backdrop-blur-3xl">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_left,_rgba(56,189,248,0.26),_transparent_18%),radial-gradient(circle_at_bottom_right,_rgba(168,85,247,0.22),_transparent_24%)]" />
